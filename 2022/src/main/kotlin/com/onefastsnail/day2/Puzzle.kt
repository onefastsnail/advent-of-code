...
fun main() {
    val part1 = part1(readFile(File("src/main/kotlin/com/onefastsnail/day2/resources/input.txt").absolutePath))
    println("Part 1: $part1")

    val part2 = part2(readFile(File("src/main/kotlin/com/onefastsnail/day2/resources/input.txt").absolutePath))
