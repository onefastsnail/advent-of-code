...
fun main() {
    val part1 = part1(readFileLines(File("src/main/kotlin/com/onefastsnail/day1/resources/input.txt").absolutePath))
    println("Part 1: $part1")

    val part2 = part2(readFileLines(File("src/main/kotlin/com/onefastsnail/day1/resources/input.txt").absolutePath))
