...
parsePuzzleInput : String -> List (List Direction)
...
generatePathPoints : Point -> Point -> Path
generatePathPoints ( x0, y0 ) ( x1, y1 ) =
    let
        xDistance =
...
convertDirectionsToPath : List Direction -> Path
convertDirectionsToPath directions =
    List.foldl
        (\a b ->
            let
                z =
...
findIntersections : List Path -> List Point
